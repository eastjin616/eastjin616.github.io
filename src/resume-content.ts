...
export const resumeData = {
  profile: {
    ...
    coreSkills: [
      ...
      { label: '백엔드', skills: 'Python · FastAPI · Java · Spring' },
      { label: 'DB', skills: 'PostgreSQL · MySQL · Oracle SQL' },
      { label: '시스템 운영', skills: 'Linux · Tomcat · 로그 분석 · 장애 대응' },
      { label: 'AI 활용', skills: 'LLM API · MCP · Codex · Claude Code · Gemini' },
    ],
  },
  timeline: [
    { role: '시스템 개발·운영', company: '효성ITX', period: '2026.05 - 현재', title: '삼성화재 IPCC IVR 시나리오 개발·운영 (3인 분담)' },
  ...
  projects: [
    { slug: 'samsung-ipcc', title: '삼성화재 IPCC IVR 시나리오\n개발·운영 (3인 분담)', company: '효성ITX', period: '2026.05 - 현재', role: '시스템 개발·운영', stack: ['Linux / Node.js / Java / Spring', 'Tomcat'], summary: '삼성화재 IPCC 3인 분담 구조에서 IVR 시나리오 신규·변경 개발 및 운영을 담당하고 있습니다. 담당 구간의 콜 라우팅 분기와 음성 응답 흐름, ADNS 연계 정합성을 확인하며 장애 발생 시 로그와 처리 데이터를 바탕으로 원인을 분석하고 대응합니다.', sections: [{ title: '[IVR 시나리오 개발 및 운영]', bullets: ['담당 구간 IVR 시나리오 개발 · 단위테스트 · 운영 대응 (설계·배포는 공동 수행)', '콜 라우팅 분기, 멘트·입력값 처리, DNS 기반 서비스 연계 정합성 확인', 'Linux · Tomcat 환경의 프로그램 반영, 재기동, 오류 확인 절차 수행'] }, { title: '[DR 이중화 환경 및 장애 대응]', bullets: ['상암-춘천 DR 이중화 환경과 장애 시 절체 체계 운영 지원', '로그 · 모니터링 데이터 기반 장애 원인 분석', '유관부서 협업을 통한 장애 조치 및 결과 확인'] }] },
    { slug: 'devai-cli', title: 'KT DS DEV.AI CODE\nCLI 개발', company: '이트리즈시스템', period: '2026.01 - 2026.05', role: 'CLI 설계·개발', stack: ['Go / Cobra / Bubble Tea'], summary: '개발환경의 설치, 인증, 설정, 업데이트 과정을 표준화하기 위한 DEV.AI CODE CLI 개발에 참여했습니다. 설계는 공동 참여하고 서브커맨드·자동 업데이트·크로스 빌드·TUI 구현을 담당했습니다(배포 제외).', sections: [{ title: '[CLI 아키텍처와 개발환경 자동화]', bullets: ['Go · Cobra 기반 단일 바이너리 CLI 구조 설계 공동 참여 및 구현 담당', 'init / config / auth / update / mcp 서브커맨드 체계 구현 담당', '서버-로컬 버전 비교 기반 업데이트와 운영체제별 바이너리 교체 로직 구현'] }, { title: '[크로스 플랫폼과 터미널 UI 구현]', bullets: ['macOS · Linux · Windows 크로스 플랫폼 빌드 및 실행 이슈 해결', 'Bubble Tea · Lip Gloss 기반 진행 상태, 확인, 모델 선택 UI 구성', 'Claude Code · Cursor와 MCP 기반 도구 연동을 실무에 적용'] }] },
